...
/**
 * диалог редактирования значения характеристики типа "list"
 * @var Good     $good
...
echo
	...
	. CHtml::dropDownList('value',$good->getPropertyValue($property),$property->getPossibleValues(),array('id' => "value_$id"))
	. '<br>' . $saveButton
	. CHtml::endForm();