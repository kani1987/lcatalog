...
/**
 * диалог редактирования значения характеристики типа "text"
 * @var Good     $good
...
$('#save_good_property_value_{$good->Id}_{$property->Id}').click(function(){
	var value = $('#value_$id').first().attr('checked');
...
echo
	...
	. CHtml::checkBox('value',$good->getPropertyValue($property),array('id' => "value_$id"))
	. '<br>' . $saveButton
	. CHtml::endForm();